...
export const headers: HeadersFunction = () => {
  return {
    // "Cache-Control":
    //   "public, max-age=60, s-maxage=60, stale-while-revalidate=60, stale-if-error=120",
    'Cache-Control': 'public, max-age=120, s-maxage=120, stale-while-revalidate=120, stale-if-error=86400',
  };
};
